    ...
    <section className={`px-4 sm:px-6 py-12 md:py-16 ${buttonVariant === "primary" ? "bg-gradient-to-br from-gray-900 to-black" : "bg-gray-100"} text-center`}>
      ...
      >
        ...
        <Button
          ...
          className={`px-6 py-3 text-sm md:text-base transition-all duration-300 inline-flex items-center justify-center gap-2 rounded-md w-full sm:w-auto ${buttonVariant === "primary"
